...
<head>
    ...
    <title>Sistema</title>
    <!-- Links bibliotecas -->
    <script src="https://kit.fontawesome.com/e4d4292657.js" crossorigin="anonymous"></script>
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-user-edit"></i> Preencha os Campos Abaixo
                    <?php 
                    if(isset($_SESSION['msg']))
                        //echo para printar e unset para mostrar 1x e destruir
                        echo $_SESSION['msg'];
                        unset($_SESSION['msg']);
                    ?>
                </div>
